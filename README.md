...
## config of mikro-orm
mikro-orm.config.ts
consists of config changing the 
user, password, dbname will help you make your local postgresql setup.
migrations.
for defining new entities.
## new module entities must be imported and define in the config file
